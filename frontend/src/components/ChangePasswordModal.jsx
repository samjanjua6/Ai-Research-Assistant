  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        ...
        {/* Modal Body Container with consistent 28px horizontal padding */}
        <div style={{ padding: '20px 28px 26px', display: 'flex', flexDirection: 'column' }}>
          ...
          >
            ...
            {/* New password */}
            <div className="form-group" style={{ gap: 6 }}>
              <label className="form-label" htmlFor="change-new-password" style={{ margin: 0 }}>
                New Password <span className="form-hint" style={{ marginLeft: 4 }}>(min 8 characters)</span>
              </label>
              <div className="input-with-toggle">
                <input
